 ...
 * -----------------------
 * This class provides an interface to the VGA hardware, specifically targeting mode 13h
 * (320x200 with 256 colors). The VGA hardware is controlled through various I/O ports
 * that are grouped into several functional units:
 *
...
protected:
    ...
    include::Port8Bit graphics_controller_index_port;// 0x3ce - Graphics Controller Index
    include::Port8Bit graphics_controller_data_port; // 0x3cf - Graphics Controller Data
    include::Port8Bit attribute_controller_index_port;// 0x3c0 - Attribute Controller Index
    include::Port8Bit attribute_controller_read_port;// 0x3c1 - Attribute Controller Read
    include::Port8Bit attribute_controller_write_port;// 0x3c0 - Attribute Controller Write
    include::Port8Bit attribute_controller_reset_port;// 0x3da - Attribute Controller Reset
...
public:
    ...
    virtual bool supports_mode(uint32_t width, uint32_t height, uint32_t colordepth);
