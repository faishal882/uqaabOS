...
void uqaabOS::include::GDTDescriptor::setGDTSegment(uint32_t base , uint32_t limit , uint8_t access){

	//The target pointer is used to representation of the SegmentDescriptor object.
...
uint32_t uqaabOS::include::GDTPointer::getLimit(){

	return limit;
}

//get base of GDTPointer
uint32_t uqaabOS::include::GDTPointer::getBase(){
	return base;
}
